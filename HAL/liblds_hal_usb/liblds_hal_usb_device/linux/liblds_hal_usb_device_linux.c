...
/* Define  -------------------------------------------------------------------*/
struct LDS_USB_DEVICE_CTX{
    LDS_USB_DEVICE_ErrorNo curr_err_state;
};

/* Define variable  ----------------------------------------------------------*/
static struct LDS_USB_DEVICE_CTX ctx;
...
*	warning			:
*******************************************************************************/
static int lds_hal_usb_device_get_error(void)
{
    return 0;
}
...
struct LDS_USB_DEVICE_OPERATION lds_hal_usb_device = {
    ...
    .comm.lds_hal_get_error     = lds_hal_usb_device_get_error,
